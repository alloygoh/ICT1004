            ...
            <div class="wrap-contact100">
                <form class="contact100-form" id="insert-form" method="POST">
                    ...
                    <div class="wrap-input100 bg1">
                        ...
                        <input list="tags" required class="input100" id="post-tag" name="post-tag" aria-describedby="post-tag" placeholder="What is your post about?">
                        <datalist id="tags">
                        </datalist>
                    </div>
